...
namespace Data.Data.Validation
{
    public class XmlLoader
    {
        ...
        public void Loader()
        {
            ...
            XDocument xDocumentMetric =
                ...
                Assembly.GetExecutingAssembly().GetManifestResourceStream("Data.Data.General." +
                "Metrics.xml")));
        ...
        public static System.Xml.XmlDocument Dimensions
        {
            get
            {
                ...
                dimessions.Load(System.Xml.XmlReader.Create(
                    System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Data.Data.General.Dimession.xml")));
                return dimessions;
            }
        }
